          ...
          child: ListView(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/forgetP.png"),
                  ),
                ),
              ),
              Text(
                AppLocalizationsAr.instance.formForgetPageForgotPassword,
                textAlign: .center,
              ...
              Container(
                ...
                child: Text(
                  AppLocalizationsAr.instance.formForgetPageDescription,
                  textAlign: .center,
                ...
                builder: (context, state) {
                  return PrimaryAuthButton(
                    ...
                    text: AppLocalizationsAr
                        .instance
                        .formForgetPageSendRecoveryLink,
                    onTap: () async {
